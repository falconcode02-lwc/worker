...
@Schema(
        name = "WorkspaceListDTO",
        description = "Lightweight representation of a workspace used in list and search responses"
)
public class WorkspaceListDTO {
    ...
    @Schema(
            description = "Indicates whether the workspace is active",
            example = "true"
    )
